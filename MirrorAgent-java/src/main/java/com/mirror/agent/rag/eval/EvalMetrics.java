...
public final class EvalMetrics {
    ...
    /** calcNDCGAtK: DCG@K / IDCG@K (rel_i = 1 iff retrieved_i in relevant). */
    public static double calcNDCGAtK(List<String> retrievedIds, List<String> relevantIds, int k) {
        ...
        int ideal = Math.min(k, relevantIds.size());
        double idcg = 0;
