...
export type ClientMessage =
  ...
  | { type: 'match_check'; jd: string; resume: string }
...
export type ServerMessage =
  ...
  | { type: 'match_report'; content: string }
...
export interface ChatMessage {
  ...
  content: string
  messageType: 'text' | 'score' | 'report' | 'review_plan' | 'match_report' | 'stage' | 'question' | 'file' | 'upload_result' | 'rag_evaluation'
  timestamp: number
  score?: number
  feedback?: string
  keyPointsHit?: string[]
